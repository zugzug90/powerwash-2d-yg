...
✅ Вес билда - **4 Мб** 😱 (внутри 3 уровня - три картинки предметов, чтобы отмыть). *


// * (Можно прикрутить live update для дозагрузки картинок)


>
> ![TG Group QR](docs/img/tg_qr.png)
> 
> Сказать спасибо автору, оставить отзыв и задать вопросы можно в [Чате Сообщества "Room 606"](https://t.me/TheRoom606Chat) либо здесь в репозитории, [создав Issue](https://github.com/zugzug90/powerwash-2d-yg/issues) с вопросом и предложениями.
>
